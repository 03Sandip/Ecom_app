...
class ProductByCategoryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Future.delayed(Duration.zero, () {
      // call filterInitialProductAndSubCategory
                                      ...
                                      if (val != null) {
                                        context.proByCProvider
                                            .filterProductBySubCategory(
                                                val); //call filterProductBySubCategory
                                      }
                                    },
                                  ),
                                );
                                    ...
                                    onChanged: (val) {
                                      if (val?.toLowerCase() == 'low to high') {
                                        context.proByCProvider.sortProducts(
                                            ascending:
                                                true); // call sortProducts (ascending: true)
                                      } else {
                                        context.proByCProvider.sortProducts(
                                            ascending:
                                                false); //call sortProducts (ascending: false)
                                      }
                                    },
                                    displayItem: (val) => val,
                                  ),
                                    ...
                                    builder:
                                      ...
                                      return MultiSelectDropDown<Brand>(
                                        ...
                                        onSelectionChanged: (val) {
                                          ...
                                          context.proByCProvider
                                              .ffilterProductByBrand(); //call filterProductByBrand
